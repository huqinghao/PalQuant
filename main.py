...
parser.add_argument('--groups', default=1, type=int, help='groups to use.')
...
# logging
parser.add_argument('--log_dir', type=str, default='../results/ResNet18/')
